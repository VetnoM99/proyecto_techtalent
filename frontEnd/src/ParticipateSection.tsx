...
import './ParticipateSection.css'; // Importar los estilos CSS

// Definir las URLs de las imágenes personalizadas
const images = {
    gainPoints: '/img/imagen1.jpg',
    becomeDonor: '/img/imagen2.jpg',
    getInvolved: '/img/imagen3.jpg',
};
